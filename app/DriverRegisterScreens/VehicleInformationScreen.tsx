...
import { View, Text, StyleSheet, SafeAreaView, TouchableOpacity, Image } from 'react-native'; // Ensure Image is imported
...
const VehicleInformationScreen: React.FC = () => {
  ...
  const [isVehicleDetailsCompleted, setIsVehicleDetailsCompleted] = useState(false);
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <Text style={styles.subtitleCentered}>
          Under this section, enter the details of vehicle number,
          photo of your vehicle, Registration Certificate and Permit.
        </Text>
        ...
        <View style={styles.listContainer}>
          ...
          <TouchableOpacity style={styles.listItem} onPress={() => handleItemPress('Registration Certificate (RC)')}>
            <Text style={styles.listItemText}>Registration Certificate (RC)</Text>
            <Ionicons name="arrow-forward" size={24} color="#0C2353" />
          </TouchableOpacity>
          <TouchableOpacity style={styles.listItem} onPress={() => handleItemPress('Permit')}>
            <Text style={styles.listItemText}>Permit</Text>
            <Ionicons name="arrow-forward" size={24} color="#0C2353" />
          </TouchableOpacity>
          <TouchableOpacity style={styles.listItem} onPress={() => handleItemPress('Vehicle Insurance')}>
...
const styles = StyleSheet.create({
  ...
  listItemCompleted: { // New style for completed item
  ...
  // New style for the completed image icon
  completedIcon: {
    width: 24, // Match Ionicons size
    height: 24, // Match Ionicons size
    // No tintColor needed if the image itself is blue/white
  },
  ...
  proceedButton: {
    // This style now belongs to the TouchableOpacity wrapper around LinearGradient
    // The LinearGradient itself has the background styling
    width: '100%',
    borderRadius: 8, // Apply border radius here
    overflow: 'hidden', // Ensure gradient respects border radius
    backgroundColor: '#0C2353', // Fallback color
    paddingVertical: 12, // Match the padding of the gradient
